...
#ifndef __HEADER_JUNIA_CORE_EXCEPTIONS_EXUTF32STRINGENCODING
#define __HEADER_JUNIA_CORE_EXCEPTIONS_EXUTF32STRINGENCODING
...
#endif // !defined(__HEADER_JUNIA_CORE_EXCEPTIONS_EXUTF32STRINGENCODING)
