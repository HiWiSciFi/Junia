...
#ifndef __HEADER_JUNIA_CORE_EXCEPTIONS_EXUTF16STRINGENCODING
#define __HEADER_JUNIA_CORE_EXCEPTIONS_EXUTF16STRINGENCODING
...
#endif // !defined(__HEADER_JUNIA_CORE_EXCEPTIONS_EXUTF16STRINGENCODING)
