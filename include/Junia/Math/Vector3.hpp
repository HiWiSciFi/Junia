 ...
 *
 * @file      Vector3.hpp
 * @brief     Contains the Vector3 class definition
 * @author    Max Hager
 * @date      2024-07-21
...
#ifndef __HEADER_JUNIA_MATH_VECTOR3
#define __HEADER_JUNIA_MATH_VECTOR3
...
#endif // !defined(__HEADER_JUNIA_MATH_VECTOR3)
