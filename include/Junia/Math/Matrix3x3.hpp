 ...
 *
 * @file      Matrix3x3.hpp
 * @brief     Contains the Matrix3x3 class definition
 * @author    Max Hager
 * @date      2024-07-21
...
#ifndef __HEADER_JUNIA_MATH_MATRIX3X3
#define __HEADER_JUNIA_MATH_MATRIX3X3
...
template <typename T>
inline float Matrix<3, 3, T>::Determinant() const {
...
#endif // !defined(__HEADER_JUNIA_MATH_MATRIX3X3)
