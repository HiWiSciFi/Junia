 ...
 *
 * @file      Matrix4x4.hpp
 * @brief     Contains the Matrix4x4 class definition
 * @author    Max Hager
 * @date      2024-07-21
...
#ifndef __HEADER_JUNIA_MATH_MATRIX4X4
#define __HEADER_JUNIA_MATH_MATRIX4X4
...
#endif // !defined(__HEADER_JUNIA_MATH_MATRIX4X4)
